...
! ------------------------------------------------------------------------------  
! File created at 15:48 on 27.10.2016   
! ----------------------------------------------------------------------  
 
 
Module TreeLevelMasses_LRmodelstripletLRDM 
...
Complex(dp) :: MFcppC 
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesLRmodels/tripletLRDM'
...
End Module TreeLevelMasses_LRmodelstripletLRDM 
