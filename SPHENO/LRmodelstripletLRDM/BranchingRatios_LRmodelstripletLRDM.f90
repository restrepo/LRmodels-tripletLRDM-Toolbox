...
! ------------------------------------------------------------------------------  
! File created at 15:50 on 27.10.2016   
! ----------------------------------------------------------------------  
 
 
Module BranchingRatios_LRmodelstripletLRDM 
 
Use Control 
Use Couplings_LRmodelstripletLRDM 
Use Model_Data_LRmodelstripletLRDM 
Use LoopCouplings_LRmodelstripletLRDM 
Use Fu3Decays_LRmodelstripletLRDM 
Use Fe3Decays_LRmodelstripletLRDM 
Use Fd3Decays_LRmodelstripletLRDM 
Use Fv3Decays_LRmodelstripletLRDM 
Use TreeLevelDecays_LRmodelstripletLRDM 
...
End Module BranchingRatios_LRmodelstripletLRDM 
