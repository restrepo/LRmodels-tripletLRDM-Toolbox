...
! ------------------------------------------------------------------------------  
! File created at 15:55 on 27.10.2016   
! ----------------------------------------------------------------------  
 
 
Program SPhenoLRmodelstripletLRDM 
 
Use Control
Use InputOutput_LRmodelstripletLRDM
Use LoopFunctions
Use RunSM_LRmodelstripletLRDM
Use LowEnergy_LRmodelstripletLRDM
Use FlavorKit_LFV_LRmodelstripletLRDM
Use FlavorKit_QFV_LRmodelstripletLRDM
Use FlavorKit_Observables_LRmodelstripletLRDM
Use Mathematics
Use Model_Data_LRmodelstripletLRDM
Use Tadpoles_LRmodelstripletLRDM 
 Use HiggsCS_LRmodelstripletLRDM
Use TreeLevelMasses_LRmodelstripletLRDM
Use LoopMasses_LRmodelstripletLRDM
 
Use BranchingRatios_LRmodelstripletLRDM
...
End Program SPhenoLRmodelstripletLRDM 
