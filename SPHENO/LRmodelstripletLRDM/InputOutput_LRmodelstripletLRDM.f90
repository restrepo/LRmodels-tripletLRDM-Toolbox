...
Module InputOutput_LRmodelstripletLRDM 
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - LRmodels/tripletLRDM Spectrum + Decays + Flavor Observables"
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.LRmodelstripletLRDM",status="unknown")
...
End Module InputOutput_LRmodelstripletLRDM 
